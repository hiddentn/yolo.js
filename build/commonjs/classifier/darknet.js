...
var DarknetClassifier = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        _a = tf_1.tf.tidy(function () {
                            var logits = _this.classifyInternal(image);
                            var classes = tf_1.tf.softmax(logits);
                            return tf_1.tf.topk(classes, _this.topK, true);
                    ...
                    case 3:
                        ...
                        tf_1.tf.dispose({ values: values, indices: indices });
    ...
    DarknetClassifier.prototype.classifyInternal = function (image) {
        ...
        return tf_1.tf.tidy(function () {
            var data = preProcess_1.preProcess(image, _this.modelSize, _this.resizeOption);
...
exports.DarknetClassifier = DarknetClassifier;
