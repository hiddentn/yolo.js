...
import { YOLOInput, modelSize,ImageOptions} from "../types";
 ...
 */
export function preProcess(input: YOLOInput,size:modelSize,options:ImageOptions): [number, number, tf.Tensor<tf.Rank.R4>] {
